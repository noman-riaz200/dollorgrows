  ...
  return (
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-logo-block">
          <div className="footer-logo">
            ...
            <span>DollarGrowth</span>
          </div>
          <p className="footer-tagline">
            Empowering financial growth through innovative investment solutions and community-driven success.
          </p>
        ...
        <div className="footer-column">
          ...
          <ul className="footer-links" aria-label="Footer resources">
            <li>
        ...
        <div className="footer-column">
          ...
          <ul className="footer-links" aria-label="Footer legal links">
            <li>
            ...
            <li>
              <a className="footer-link" href="/aml">
                AML Policy
              </a>
            </li>
            <li>
              <a className="footer-link" href="/kyc">
                KYC Verification
              </a>
            </li>
          </ul>
      ...
      <div className="footer-bottom">
        © 2025 DollarGrowth. All rights reserved. | Designed with ❤️ for financial empowerment
      </div>
    </footer>
  );
}
