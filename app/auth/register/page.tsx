  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] relative overflow-hidden flex items-center justify-center px-4 py-8">
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        <GlassCard padding="lg" glow="green" className="animate-float">
          ...
          <button
            ...
            className={cn(
              ...
              "hover:bg-white/[0.06] hover:border-[#00ff88]/30 hover:glow-green-sm",
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              {errors.referralCode && (
                <p className="mt-1.5 text-red-400 text-xs">{errors.referralCode.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.country && (
                <p className="mt-1.5 text-red-400 text-xs">{errors.country.message}</p>
              )}
            </div>
